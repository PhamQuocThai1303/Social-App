...
const EditProfile = ({ user, setIsEdit }) => {
    ...
    return (
        <div >
            ...
            <div id="default-modal" data-modal-show="true" aria-hidden="true" className="bg-gray-200 overflow-x-hidden overflow-y-auto fixed h-modal sm:h-full top-4 left-0 right-0 sm:left-0 sm:right-0 sm:inset-0 z-50 justify-center items-center">
