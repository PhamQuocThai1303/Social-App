...
const InputComment = ({ post }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const { newComment2 } = await createComment({ postId: post?._id, userId: user?._id, ...newComment }).unwrap()
    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center px-3 py-2 rounded-lg dark:bg-gray-700">
                ...
                <textarea id="chat" rows="1" className="block mx-4 p-2.5 w-full max-h-[120px] text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your message..." value={content} onChange={e => setContent(e.target.value)}></textarea>
